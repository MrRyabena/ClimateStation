...
class shs::Pressure_chart : public shs::Widget
{
public:
    ...
    Pressure_chart(std::shared_ptr<shs::ClimateStationStorage> storage, std::shared_ptr<TFT_eSPI> tft, std::shared_ptr<shs::ChartAnalyzer> analyzer,
